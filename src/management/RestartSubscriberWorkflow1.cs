...
namespace management
{
	...
	//	private readonly MemoryCache _operationsBuffer = new MemoryCache(new MemoryCacheOptions());
	...
	//		_operationsBuffer.Set(
	//			message.Data.WorkflowId + eventId.ToString(),
	//			operation, 
	...
	//					{
	//						EvictionCallback = delegate { operation(); }
	//					}
	//				}, 
